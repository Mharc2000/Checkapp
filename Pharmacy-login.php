...
<html lang="en">
  ...
  <body style="font-family: 'Poppins', sans-serif;">
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "SELECT * FROM pharmacy_record WHERE Email='$Email' AND Password='$Password'";
    ...
    <section class="Form my-2 mx-2 mt-4">
        <div class="container">
            <div class="row g-0" style="border-radius: 30px;" id="shadow">
                <div class="col-lg-6">
                    <img src="img/cover3.jpg" width="2000" height="2000" class="img-fluid" alt="cover" style="border-radius: 30px;">
                </div>
                <div class="col-lg-6 px-5 pt-5" id="shadow">
                    <h1 class="font-weight-bold py-3"> <span style="color:green">PHARMACY</span> LOGIN  PAGE</h1>
                    <h4>Sign into your account</h4>
                    <form action="" method="POST">
                        <div class="form-row pt-1">
                            <div class="col-lg-10">
                                <label class="label mx-2">Email address</label>
                                <input type="Text" placeholder="Username" class="form-control  p-3" id="Email" name="Email">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-lg-10">
                                <div class="d-flex pt-2">
                                    <button type="submit" name="submit" id="yawa" class="btn1 flex-grow-1">Login</button>
                                </div>
                            ...
                            <div class="col-lg-10">
                                <div class="d-flex pt-2">
                                    <a href="Pharmacy-register.php" type="button" style="text-decoration: none; text-align:center;" class="btn1 flex-grow-1 text-white">Create Account</a>
                                </div>
                            </div>
